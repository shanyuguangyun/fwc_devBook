<template><div><h1 id="前端选型" tabindex="-1"><a class="header-anchor" href="#前端选型"><span>前端选型</span></a></h1>
<blockquote>
<p>1.工具</p>
</blockquote>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line">本次前端可能会使用多种技术，</span>
...
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># 创建vue2项目有几种方式，使用vite、使用vue-cli、使用webpack手动创建</span></span>
...
<p>本项目使用vue-cli5.x创建项目，结构如下。如果是vue-cli2.x，则会包含static目录、build目录等。而build目录被vue.config.js替代。</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html"><pre v-pre><code><span class="line">project-root/</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/dev-log/images/vue2struct.png" alt="ss"></p>
</div></template>
